...
//	}
	...
	public void registerTypeOverride(BasicType type) {
		typeConfiguration.getBasicTypeRegistry().register( (org.hibernate.type.BasicType) type );
	}
	...
	public BasicType basic(String name) {
		return (BasicType) typeConfiguration.getBasicTypeRegistry().getRegisteredType( name );
	}
	 ...
	 */
	public BasicType heuristicType(String typeName) throws MappingException {
	 ...
	 */
	public BasicType heuristicType(String typeName, Properties parameters) throws MappingException {
		BasicType type = basic( typeName );
		if ( type != null ) {
			return type;
		}
		...
		try {
			...
			Class<Object> typeClass = classLoaderService.classForName( typeName );
			if ( typeClass != null ) {
				return (BasicType) typeFactory.byClass( typeClass, parameters );
			}
		}
