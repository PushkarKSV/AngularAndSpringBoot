...
@Component({
  selector: 'app-trader-stats',
  templateUrl: './trader-stats.component.html',
  styleUrls: ['./trader-stats.component.css']
})

export class TraderStatsComponent implements OnInit {
  startdateValue: Date;
  enddateValue: Date;
  isShow = false;
  display1 = 'none';
